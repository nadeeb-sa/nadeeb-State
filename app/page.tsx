...
function StatCard({ label, value, sub1Label, sub1, sub2Label, sub2, color }: {
  ...
  return (
    <div className="bg-white/5 rounded-2xl p-6 border border-white/10 hover:border-opacity-30 transition-all"
      style={{ borderColor: `${color}30` }}>
      <div className="flex items-center justify-between mb-4">
        <span className="text-gray-400 text-sm font-medium">{label}</span>
        <div className="w-2 h-2 rounded-full" style={{ backgroundColor: color }} />
      </div>
      <div className="text-4xl font-bold text-white mb-4" style={{ fontVariantNumeric: "tabular-nums" }}>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
              <StatCard
                ...
                sub1Label="اليوم"
                sub1={stats.today.delegates}
                sub2Label="هذا الأسبوع"
                sub2={stats.week.delegates}
                color="#156661"
              />
              <StatCard
                label="الشركات"
                ...
                sub1Label="اليوم"
                sub1={stats.today.companies}
                sub2Label="هذا الأسبوع"
                sub2={stats.week.companies}
                color="#c0973b"
              />
              <StatCard
                label="المستثمرين"
                ...
                sub1Label="اليوم"
                sub1={stats.today.investors}
                sub2Label="هذا الأسبوع"
                sub2={stats.week.investors}
                color="#6366f1"
              />
            </div>
            ...
            <div className="bg-white/5 rounded-2xl border border-white/10 overflow-hidden">
              ...
              <div className="divide-y divide-white/5">
                {stats.recent.map((row, i) => {
                  const cfg = TYPE_CONFIG[row.type] || TYPE_CONFIG.delegate;
                  return (
